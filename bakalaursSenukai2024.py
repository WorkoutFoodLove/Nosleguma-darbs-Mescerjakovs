...
BASE_URL = "https://www.ksenukai.lv/c/tv-audio-video-spelu-konsoles/audio-aparatura/austinas/ci1?page="
SLEEP_INTERVAL = 1
    ...
    while len(product_urls) < 500:
        ...
        if container:
            ...
            for product_name in product_names:
                product_urls.append(product_name['href'])
...
def main():
    ...
    with open('productsSenukai2024.csv', 'w', encoding='UTF-8', newline='') as file:
